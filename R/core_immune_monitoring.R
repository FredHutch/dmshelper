...
#'
#' @examples
immune_update <- function(session){
  # I
  # DATATYPE
  ## Raw
  shiny::updateTextInput(session, "raw_data_present", value = TRUE)
  shiny::updateTextInput(session, "technology_description", value = "assay results for clinical trials using [insert technology description]")
  shiny::updateTextInput(session, "raw_file_description", value = "Excel files and [insert other raw files]")

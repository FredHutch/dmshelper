...
flow_cytometry_core_standards <- function() {
  return(c(
    ...
    "### Standards",
    "",
    paste0("<font color='OA799A'>The data produced in this project will be collected using the Minimum Information about a Flow Cytometry Experiment (MIFlowCyt) standard established by the International Society for Analytical Cytology Data Standards Task Force (ref: https://doi.org/10.1002%2Fcyto.a.20623).</font>"),
    ""
  ))
}
...
flow_cytometry_core_preservation <- function(
    input
) {
  return(
    preservation_txt(

  ...
  return(
    paste0(
      paste0(
        ...
        if (input$name_role == "") {" ___ "} else {input$name_role}
      ),
      if (input$core_datatype %in% c("small_animal")) {
        ...
        paste0(
          ...
          if (input$review_frequency == "") {" ___ "} else {input$review_frequency},
...
oversight_self <- function(input) {
  return(
    paste0(
      ...
      if (input$review_addtnl == "") {" ___ "} else {input$review_addtnl},
      ".</font>"
    )
  )
}

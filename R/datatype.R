...
raw_data_chunk <- function(input) {
  return(
    ...
    if (input$core_datatype == "immune") {
      ...
      } else if (input$core_datatype %in% c("preclinical_img_ivis", "preclinical_img_microct", "preclinical_img_mri")) {
        paste0("**Technology:** We will collect <font color='OA799A'>", input$technology_description,"</font>. ")
      } else {
    ...
    if (input$core_datatype == "proteomics") {
        paste0("The amount of data generated per file will be <font color='OA799A'>", input$avg_file_size, "</font>. ")
      } else {
  ...
  return(
    paste0(
      ...
      if (input$core_datatype %in% c("preclinical_img_microct")) {
        paste0("The amount of data generated per timepoint <font color='OA799A'>", input$avg_processed_file_size, "</font>. ")
      } else if (input$core_datatype == "proteomics") {
        paste0("The amount of data generated per file will be <font color='OA799A'>", input$avg_processed_file_size, "</font>. ")
      } else {
        paste0("The amount of data generated per sample <font color='OA799A'>", input$avg_processed_file_size, "</font>. ")
      },
